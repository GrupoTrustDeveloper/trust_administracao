document.addEventListener('DOMContentLoaded', () => {
    ...
    if (menuUsers) menuUsers.addEventListener('click', handleLoadUsers);
    if (menuCadastroBasico) menuCadastroBasico.addEventListener('click', renderCadastroBasico);
    if (menuCadastroPontos) menuCadastroPontos.addEventListener('click', renderCadastroPontos);
